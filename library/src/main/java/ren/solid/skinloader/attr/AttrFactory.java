...
public class AttrFactory {
    ...
    public static final String LISTVIEW_DIVIDER = "divider";
    ...
    public static SkinAttr get(String attrName, int attrValueRefId, String attrValueRefName, String typeName) {
        ...
        } else if (LISTVIEW_DIVIDER.equals(attrName)){
            mSkinAttr = new ListViewDividerAttr();
            Log.i(TAG, "create:ListViewDividerAttr");
    ...
    public static boolean isSupportedAttr(String attrName) {
        ...
        if (LISTVIEW_DIVIDER.equals(attrName)) {
            return true;
        }
